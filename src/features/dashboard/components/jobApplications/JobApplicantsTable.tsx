...
import ApplicationStatusBadge from '../myApplications/ApplicationStatusBadge';

type JobApplicantsTableProps = {
  jobId: string;
          ...
          {applications.map((application, index) => (
            <tr
              ...
              <td className="px-4 py-3">
                <Link
                  to={`/dashboard/jobs/${jobId}/applications/${application.id}`}
                  className="flex items-center gap-3 min-w-0 group">
                  <div className="size-10 rounded-full overflow-hidden shrink-0 bg-surface-container-high flex items-center justify-center text-outline">
