...
import { FileText, Upload, CheckCircle, Clock, Briefcase, MapPin, ChevronDown } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-6 space-y-6">
      ...
      <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-6 md:p-8 relative">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-6">
          <div>
            <h1 className="text-headline-lg font-bold text-on-surface mb-2">{jobTitle}</h1>
          ...
          <div className="bg-surface-container rounded-lg p-4 w-full md:w-64 border border-outline-variant/30">
            <p className="text-label-md font-medium text-on-surface-variant mb-2">APPLICANT INFO</p>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-primary text-on-primary flex items-center justify-center font-bold">
                JD
              </div>
              <div>
                <p className="text-body-md font-bold text-on-surface">Jane Doe</p>
                <p className="text-label-md text-on-surface-variant">j.doe@example.com</p>
              </div>
            </div>
            <Link to="/profile" className="block mt-3 text-body-md text-primary hover:underline">
      ...
      <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-6 md:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="border-2 border-dashed border-outline-variant rounded-lg p-8 text-center hover:border-primary/50 transition-colors cursor-pointer group">
            <Upload className="mx-auto text-on-surface-variant group-hover:text-primary transition-colors mb-2" size={32} />
            <p className="text-body-md font-medium text-on-surface">Resume / CV</p>
            <p className="text-label-md text-on-surface-variant">PDF, DOCX up to 10MB</p>
          </div>
          {/* Certifications Upload */}
          <div className="border-2 border-dashed border-outline-variant rounded-lg p-8 text-center hover:border-primary/50 transition-colors cursor-pointer group">
            <CheckCircle className="mx-auto text-on-surface-variant group-hover:text-primary transition-colors mb-2" size={32} />
            <p className="text-body-md font-medium text-on-surface">Certifications / Licenses</p>
            <p className="text-label-md text-on-surface-variant">Add up to 3 documents</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-6 md:p-8">
        <h2 className="text-headline-md font-bold text-on-surface mb-6 flex items-center gap-2">
          <Briefcase className="text-primary" size={24} /> Experience & Availability
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-body-md font-medium text-on-surface mb-2">Years of Relevant Experience</label>
            <div className="relative flex items-center">
              ...
              />
              <span className="absolute right-4 text-on-surface-variant text-body-md">Years</span>
            </div>
          </div>
          <div>
            <label className="block text-body-md font-medium text-on-surface mb-2">Earliest Start Date</label>
