  ...
  if (!job) {
    return (
      <div className="bg-background min-h-screen pt-20 pb-16 flex flex-col items-center justify-center text-center px-4">
        ...
        <p className="text-body-md text-on-surface-variant mt-2 mb-4">The job you are trying to apply for does not exist.</p>
        <Link to="/jobs" className="px-6 py-2 bg-primary text-on-primary rounded-lg font-medium">Back to Jobs</Link>
      </div>
    );
  }
